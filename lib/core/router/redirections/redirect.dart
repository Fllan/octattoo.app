...
FutureOr<String?> redirect(
    BuildContext context, GoRouterState state, Ref widgetRef) async {
  logger.d('Redirecting to ${state.uri}');
  final isAuthenticated =
      widgetRef.watch(authStateChangesProvider).value != null;
...
Future<int?> currentOnboardingStep() async {
  ...
  final currentStepIndex =
      await prefs.getInt(SharedPreferencesKeys.onboardingStep);
