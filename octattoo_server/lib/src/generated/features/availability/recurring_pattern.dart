...
import '../../features/availability/recurring_type.dart' as _i3;
...
abstract class RecurringPattern
  ...
  factory RecurringPattern({
    int? id,
    required _i1.UuidValue availabilityId,
  ...
  factory RecurringPattern.fromJson(Map<String, dynamic> jsonSerialization) {
    return RecurringPattern(
      ...
      availabilityId: _i1.UuidValueJsonExtension.fromJson(
        jsonSerialization['availabilityId'],
      ),
      availability: jsonSerialization['availability'] == null
          ? null
          : _i4.Protocol().deserialize<_i2.Availability>(
  ...
  _i1.UuidValue availabilityId;

  /// Reference to the availability associated with the recurring pattern
  _i2.Availability? availability;
  ...
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'RecurringPattern',
      if (id != null) 'id': id,
...
class _RecurringPatternImpl extends RecurringPattern {
  ...
  RecurringPattern copyWith({
    ...
    return RecurringPattern(
      ...
      separationCount: separationCount is int?
          ? separationCount
          : this.separationCount,
...
class RecurringPatternUpdateTable
    extends _i1.UpdateTable<RecurringPatternTable> {
  RecurringPatternUpdateTable(super.table);

  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue> availabilityId(
    _i1.UuidValue value,
  ) => _i1.ColumnValue(
  ...
  _i1.ColumnValue<_i3.RecurringType, _i3.RecurringType> recurringType(
    _i3.RecurringType value,
  ) => _i1.ColumnValue(
    table.recurringType,
    value,
  );

  _i1.ColumnValue<int, int> separationCount(int? value) => _i1.ColumnValue(
    table.separationCount,
    value,
  );
  ...
  _i1.ColumnValue<int, int> weekOfMonth(int? value) => _i1.ColumnValue(
    table.weekOfMonth,
    value,
  );
  ...
  _i1.ColumnValue<int, int> monthOfYear(int? value) => _i1.ColumnValue(
    table.monthOfYear,
    value,
  );
}

class RecurringPatternTable extends _i1.Table<int?> {
  RecurringPatternTable({super.tableRelation})
    : super(tableName: 'recurring_pattern') {
    updateTable = RecurringPatternUpdateTable(this);
    availabilityId = _i1.ColumnUuid(
      'availabilityId',
      this,
    );
  ...
  late final RecurringPatternUpdateTable updateTable;

  late final _i1.ColumnUuid availabilityId;
...
class RecurringPatternInclude extends _i1.IncludeObject {
  ...
  @override
  _i1.Table<int?> get table => RecurringPattern.t;
}
...
class RecurringPatternRepository {
  ...
  /// Updates a single [RecurringPattern] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<RecurringPattern?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<RecurringPatternUpdateTable>
    columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<RecurringPattern>(
      id,
      columnValues: columnValues(RecurringPattern.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [RecurringPattern]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<RecurringPattern>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<RecurringPatternUpdateTable>
    columnValues,
    ...
    return session.db.updateWhere<RecurringPattern>(
      columnValues: columnValues(RecurringPattern.t.updateTable),
